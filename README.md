...
这个 Skill 适合放进 Codex、WorkBuddy、Claude Code 或其他能读取本地文件的 Agent 工作流里。Codex 只是其中一种运行环境。

它做的事很朴素：帮你把“我是谁、我想找什么、哪些公司值得去、进去以后有没有前途、简历怎么写、面试怎么讲”放到同一张桌子上判断。
...
这里说的“公司调研”不是查一下公司真假。基础核验只是一小步，真正重要的是回答用户关心的问题：这家公司值不值得投，进去以后能不能成长，会不会消耗很大，岗位是不是有前途。
...
先挖掘我的真实需求、经历、偏好和保密边界；再调研岗位里的公司与职业前景，重点看发展前途、岗位成长性、职业压力、晋升空间、团队氛围和论坛/社区反馈；然后归纳岗位市场和适合方向，筛选目标机会，判断需要多少份简历并生成对应版本，同时准备面试材料和30/90/180天提升计划。
...
4. 公司与职业前景调研：发展前途、业务质量、岗位成长性、压力强度、晋升空间、学习环境、团队氛围。
...
重点不是只看公司主体是否真实，而是看这些求职者真正关心的问题：
...
推荐来源不只包括官网和新闻，也包括论坛、员工评价、社交平台、招聘平台评论、脉脉、看准、Glassdoor、知乎、小红书、Reddit 等公开讨论。官方资料适合确认业务事实，论坛和社区更适合发现压力、氛围、晋升和管理问题。

但论坛类信息要谨慎使用：看多条独立信息是否形成同一模式，不要把单条吐槽当结论。资料不足时标记为 `incomplete` 或 `watch`，不要编结论。
