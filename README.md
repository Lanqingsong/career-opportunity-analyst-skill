...
这是一个面向求职者职业机会选择分析的 Skill。现在的招聘软件对求职者并不公平,一方面很难判断哪些公司真的适合自己，另一方面也很少告诉你，怎样在有限时间内补齐岗位差距、把经历讲清楚、把简历投到更值得投的地方。

这个 Skill 适合放进 Codex、WorkBuddy、Claude Code 或其他能读取本地文件的 Agent 工作流里。

它帮你把“我是谁、我想找什么、哪些公司值得去、对你发展是否健康、简历怎么写、面试怎么讲”,放在一个台面上进行统一综合的研究。

## 先说清楚定位

这个 Skill 不做专业的简历润色模板和岗位打分，它更像一个求职分析助理，重点有三件事：
...
这里说的“公司调研”，这家公司值不值得投，进去以后能不能成长，会不会消耗很大，岗位是不是有前途，当前这只是基于互联网知识不能代表最终真实情况。

需要注意的是，背景调查仅限互联网已知和 Agent 能获取到的公开资料，真实性仍需要用户自己核验。它不是审计，也不是保证结论，只是帮助你把多类信号整理清楚。
...
所有互联网信息都需要克制使用。融资不代表公司一定成功，机构观点可能滞后或带有立场，论坛信息也不能靠单条吐槽下结论。这些信息我让这个SKILL统一收集发送给你，以适当打破信息差
