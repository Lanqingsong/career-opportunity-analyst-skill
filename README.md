...
这是一个面向求职者职业机会选择分析的 Skill，我发现目前招聘软件对于求职者非常不公平，一方面难以找到合适的公司另一方面也不会告诉你怎么在一定时间内弥补岗位差距。这个SKILL适合放进 Codex、WorkBuddy、Claude Code 或其他能读取本地文件的 Agent 工作流里。

它帮你把“我是谁、我想找什么、这些公司靠不靠谱、哪些岗位值得投、简历应该怎么写、面试怎么讲”放到同一张桌子上判断。
